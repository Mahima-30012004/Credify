...
export default function Page() {
  return (
    <main className='min-h-screen pt-32 pb-20 px-6 max-w-4xl mx-auto text-slate-900 dark:text-slate-200'>
      ...
      <h1 className='text-5xl font-black mb-6'>Trustscore</h1>
      <div className='bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-10'>
        <p className='text-lg text-slate-600 dark:text-slate-400'>Detailed content for Trustscore is currently being updated. Check back soon for the latest information!</p>
      </div>
    </main>
  );
}
